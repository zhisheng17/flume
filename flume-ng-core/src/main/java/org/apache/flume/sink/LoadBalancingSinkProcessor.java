...
public class LoadBalancingSinkProcessor extends AbstractSinkProcessor {
    ...
    private static final String CONFIG_SELECTOR_PREFIX = CONFIG_SELECTOR + ".";
    private static final String CONFIG_BACKOFF = "backoff";

    private static final String SELECTOR_NAME_ROUND_ROBIN = "ROUND_ROBIN";
    private static final String SELECTOR_NAME_RANDOM = "RANDOM";
