        ...
        try {
            ...
            while (eventList.size() < batchUpperLimit &&
                ...
                if (useAvroEventFormat) {
                    ...
                    if (!reader.isPresent()) {
                        reader = Optional.of(new SpecificDatumReader<>(AvroFlumeEvent.class));
                    }
                ...
                if (log.isTraceEnabled()) {
                    if (LogPrivacyUtil.allowLogRawData()) {
                        ...
                        log.trace("Topic: {} Partition: {} Message arrived.", message.topic(), message.partition());
                    }
                }
            ...
            if (eventList.size() > 0) {
                ...
                getChannelProcessor().processEventBatch(eventList);//todo：
